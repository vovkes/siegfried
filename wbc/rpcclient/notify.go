...
func (c *Client) handleNotification(ntfn *rawNotification) {
	...
	case dcrjson.BtcdConnectedNtfnMethod:
		...
		if err != nil {
			log.Warnf("Received invalid wbc connected "+
				"notification: %v", err)
			return
		}
...
// parseBtcdConnectedNtfnParams parses out the connection status of wbc
...
//
// NOTE: This is a wbc extension and requires a websocket connection.
