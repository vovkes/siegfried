...
func (r FutureListLockUnspentResult) Receive() ([]*wire.OutPoint, error) {
	...
	for i, input := range inputs {
		...
		ops[i] = wire.NewOutPoint(sha, input.Vout, input.Tree) // WBC TODO
	}
...
// WBC address for receiving payments to the specified account.
...
// GetAccountAddress returns the current WBC address for receiving payments
...
// about the given wbcoin address.
...
// ValidateAddress returns information about the given wbcoin address.
...
// NOTE: While getinfo is implemented here (in wallet.go), a wbc chain server
