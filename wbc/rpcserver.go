...
// list of commands that we recognize, but for which wbc has no support because
...
func handleGetAddedNodeInfo(s *rpcServer, cmd interface{}, closeChan <-chan struct{}) (interface{}, error) {
	...
	// Retrieve a list of persistent (added) peers from the wbcoin server
...
// reasons.
// TODO WBC pop in the new errors from blockchain cj
...
func jsonAuthFail(w http.ResponseWriter) {
	w.Header().Add("WWW-Authenticate", `Basic realm="wbc RPC"`)
