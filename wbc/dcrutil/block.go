...
// Tx returns a wrapped transaction (wbcutil.Tx) for the transaction at the
...
// STx returns a wrapped transaction (wbcutil.Tx) for the stake transaction at
...
// Transactions returns a slice of wrapped transactions (wbcutil.Tx) for all
...
// instead provides easy access to wrapped versions (wbcutil.Tx) of them.
...
// STransactions returns a slice of wrapped stake transactions (wbcutil.Tx) for all
