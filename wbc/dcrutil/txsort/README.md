...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/wbcoin/wbc/dcrutil/txsort)
...
differences with WBC-specific transactions.
...
```bash
$ go get -u github.com/wbcoin/wbc/dcrutil/txsort
```
