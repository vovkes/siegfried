...
// See GoDoc for example: http://godoc.org/bitbucket.org/siegfriedvmblockchain/siegfried/wbc/dcrutil#example-Amount
...
// useful for services that build on top of wbcoin (for example, calculating
