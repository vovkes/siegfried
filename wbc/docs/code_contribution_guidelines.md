...
reason, the wbc suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire wbc
...
One of the major design goals of all core wbc packages is to aim for complete
...
contributions.  This is how to get your changes into wbc.
...
Rejoice as you will now be listed as a [contributor](https://github.com/wbcoin/wbc/graphs/contributors)!
...
[ISC license](https://github.com/wbcoin/wbc/blob/master/LICENSE).  This is
the same license as all of the code in the wbc suite.
