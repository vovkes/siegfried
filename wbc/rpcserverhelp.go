...
var helpDescsEnUS = map[string]string{
	...
	"scriptpubkeyresult-addresses": "The wbcoin addresses associated with this script",
	...
	"decodescriptresult-addresses": "The wbcoin addresses associated with this script",
	...
	"getblock-verbosetx":   "Specifies that each transaction is returned as a JSON object and only applies if the verbose flag is true (wbc extension)",
	...
	"getcurrentnet--synopsis": "Get wbcoin network the server is running on.",
	...
	"infowalletresult-balance":         "The total wbcoin balance of the wallet",
	...
	"getrawmempoolverboseresult-fee":              "Transaction fee in wbcoin",
	...
	"searchrawtransactions-address":     "The WBC address to search for",
	...
	"sendrawtransaction-allowhighfees": "Whether or not to allow insanely high fees (wbc does not yet implement this parameter, so it has no effect)",
	...
	// StopCmd help.
	"stop--synopsis": "Shutdown wbc.",
	"stop--result0":  "The string 'wbc stopping.'",
	...
	"validateaddresschainresult-address": "The wbcoin address (only when isvalid is true)",

	// ValidateAddressCmd help.
	"validateaddress--synopsis": "Verify an address is valid.",
	"validateaddress-address":   "WBC address to validate",
	...
	"verifymessage-address":   "The wbcoin address to use for the signature",
