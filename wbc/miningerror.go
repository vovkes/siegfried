...
const (
	...
	// ErrGettingMemoryUsageValue indicates that the server was unable to get the
	// VM memory usage value.
	ErrGettingMemoryUsageValue
)
...
var miningErrorCodeStrings = map[MiningErrorCode]string{
	...
	ErrGettingMemoryUsageValue: "ErrGettingMemoryUsageValue",
}
