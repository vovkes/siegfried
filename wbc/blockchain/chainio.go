...
import (
	...
	"bitbucket.org/siegfriedvmblockchain/siegfried/wbc/blockchain/internal/dbnamespace"
...
// The amount is never encoded into spent transaction outputs in WBC
...
func decodeSpentTxOut(serialized []byte, stxo *spentTxOut, amount int64,
	...
	// since in WBC we only need pkScript at most due to fraud proofs
...
// from the index, and return a wbcutil.Block with the height set.
...
// raw block for the provided height, deserialize it, and return a wbcutil.Block
// with the height set.
