...
The wbcoin block handling and chain selection rules are an integral, and quite
likely the most important, part of wbcoin.  Unfortunately, at the time of
this writing, these rules are also largely undocumented and had to be
ascertained from the bitcoind source code.  At its core, wbcoin is a
...
Since this package does not deal with other wbcoin specifics such as network
