...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/wbcoin/wbc/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/wbcoin/wbc/blockchain/fullblocktests
```
