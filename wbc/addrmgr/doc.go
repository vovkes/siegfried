...
/*
Package addrmgr implements concurrency safe WBC address manager.

Address Manager Overview

In order maintain the peer-to-peer WBC network, there needs to be a source
of addresses to connect to as nodes come and go.  The WBC protocol provides
