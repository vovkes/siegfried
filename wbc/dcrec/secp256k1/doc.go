...
/*
Package secp256k1 implements support for the elliptic curves needed for wbcoin.

WBC uses elliptic curve cryptography using koblitz curves
...
standard formats.  It was designed for use with wbc, but should be
