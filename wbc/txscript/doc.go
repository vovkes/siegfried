...
/*
Package txscript implements the wbcoin transaction script language.

This package provides data structures and functions to parse and execute
wbcoin transaction scripts.

Script Overview

WBC transaction scripts are written in a stack-base, FORTH-like language.

The wbcoin script language consists of a number of opcodes which fall into
...
The vast majority of WBC scripts at the time of this writing are of several
...
what conditions must be met in order to spend wbcoins.
