...
var (
	...
	defaultDataDir  = filepath.Join(wbcHomeDir, "data")
...
type config struct {
	DataDir           string `short:"b" long:"datadir" description:"Location of the wbc data directory"`
...
// time of writing, wbc currently places blocks for testnet version 2 in the
