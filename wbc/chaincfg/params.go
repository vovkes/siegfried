...
var (
	...
	// mainPowLimit is the highest proof of work value a WBC block can
	// have for the main network.  It is the value 2^224 - 1.
	mainPowLimit = new(big.Int).Sub(new(big.Int).Lsh(bigOne, 224), bigOne)

	// testNetPowLimit is the highest proof of work value a WBC block
	// can have for the test network.  It is the value 2^232 - 1.
	testNetPowLimit = new(big.Int).Sub(new(big.Int).Lsh(bigOne, 232), bigOne)

	// simNetPowLimit is the highest proof of work value a WBC block
...
// Params defines a WBC network by its parameters.  These parameters may be
// used by WBC applications to differentiate networks as well as addresses
...
type Params struct {
	...
	// Ticket pool sizes for WBC PoS. This denotes the number of possible
	...
	// Average number of tickets per block for WBC PoS.
...
// MainNetParams defines the network parameters for the main WBC network.
var MainNetParams = Params{
	Name:        "mainnet",
	Net:         wire.MainNet,
	DefaultPort: "9108",
	DNSSeeds: []DNSSeed{
		{"mainnet-seed.wbcoin.mindcry.org", true},
		{"mainnet-seed.wbcoin.netpurgatory.com", true},
		{"mainnet-seed.wbcoin.org", true},
	},
	...
	// WBC organization related parameters
...
var TestNet2Params = Params{
	...
	DefaultPort: "19108",
	DNSSeeds: []DNSSeed{
		{"testnet-seed.wbcoin.mindcry.org", true},
		{"testnet-seed.wbcoin.netpurgatory.com", true},
		{"testnet-seed.wbcoin.org", true},
	},
...
// SimNetParams defines the network parameters for the simulation test WBC
...
var (
	// ErrDuplicateNet describes an error where the parameters for a WBC
	// network could not be set due to the network already being a standard
	// network or previously-registered into this package.
	ErrDuplicateNet = errors.New("duplicate WBC network")
...
// Register registers the network parameters for a WBC network.  This may
