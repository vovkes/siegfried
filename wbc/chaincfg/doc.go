...
//
// In addition to the main WBC network, which is intended for the transfer
...
// wire.WBCNet using ParamsForNet, but be aware that this usage is
...
//          addr, err := wbcutil.NewAddressPubKeyHash(pubKeyHash, chainParams)
//          if err != nil {
//                  log.Fatal(err)
//          }
//          fmt.Println(addr)
//  }
//
// If an application does not use one of the three standard WBC networks,
