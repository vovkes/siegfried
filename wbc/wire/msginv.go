...
// MsgInv implements the Message interface and represents a wbcoin inv message.
...
// NewMsgInv returns a new wbcoin inv message that conforms to the Message
...
// NewMsgInvSizeHint returns a new wbcoin inv message that conforms to the
