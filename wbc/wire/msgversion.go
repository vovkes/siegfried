...
// MsgVersion implements the Message interface and represents a wbcoin version
...
// NewMsgVersion returns a new wbcoin version message that conforms to the
...
// and local address from conn and returns a new wbcoin version message that
