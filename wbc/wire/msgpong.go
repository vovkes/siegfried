...
// MsgPong implements the Message interface and represents a wbcoin pong
// message which is used primarily to confirm that a connection is still valid
// in response to a wbcoin ping message (MsgPing).
//
...
// NewMsgPong returns a new wbcoin pong message that conforms to the Message
