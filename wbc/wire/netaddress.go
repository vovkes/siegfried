...
// maxNetAddressPayload returns the max payload size for a wbcoin NetAddress
...
type NetAddress struct {
	...
	// not present in the wbcoin version message (MsgVersion) nor was it
...
func readNetAddress(r io.Reader, pver uint32, na *NetAddress, ts bool) error {
	...
	// NOTE: The wbcoin protocol uses a uint32 for the timestamp so it will
	...
	// Sigh.  WBC protocol mixes little and big endian.
