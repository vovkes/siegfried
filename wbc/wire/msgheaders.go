...
// a single wbcoin headers message.
const MaxBlockHeadersPerMsg = 2000

// MsgHeaders implements the Message interface and represents a wbcoin headers
...
// NewMsgHeaders returns a new wbcoin headers message that conforms to the
