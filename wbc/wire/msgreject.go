...
// MsgReject implements the Message interface and represents a wbcoin reject
// message.
//
...
func (msg *MsgReject) MaxPayloadLength(pver uint32) uint32 {
	// Unfortunately the wbcoin protocol does not enforce a sane
...
// NewMsgReject returns a new wbcoin reject message that conforms to the
