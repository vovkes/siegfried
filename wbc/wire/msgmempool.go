...
// MsgMemPool implements the Message interface and represents a wbcoin mempool
...
// NewMsgMemPool returns a new wbcoin pong message that conforms to the Message
