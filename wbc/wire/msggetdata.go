...
// MsgGetData implements the Message interface and represents a wbcoin
...
// NewMsgGetData returns a new wbcoin getdata message that conforms to the
...
// NewMsgGetDataSizeHint returns a new wbcoin getdata message that conforms to
