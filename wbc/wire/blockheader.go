...
// BlockHeader defines information about a block and is used in the wbcoin
...
// readBlockHeader reads a wbcoin block header from r.  See Deserialize for
...
// writeBlockHeader writes a wbcoin block header to w.  See Serialize for
