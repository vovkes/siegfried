...
// MsgBlock implements the Message interface and represents a wbcoin
...
// BtcDecode decodes from the wbcoin wire protocol as it was sent across the
...
// the wbcoin wire protocol in order to be sent across the network.  The wire
...
// NewMsgBlock returns a new wbcoin block message that conforms to the
