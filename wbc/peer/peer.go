...
// Peer provides a basic concurrent safe wbcoin peer for handling wbcoin
...
// callbacks for handling wbcoin protocol messages.
//
...
// newPeerBase returns a new base wbcoin peer based on the inbound flag.  This
...
// NewInboundPeer returns a new inbound wbcoin peer. Use Start to begin
// processing incoming and outgoing messages.
func NewInboundPeer(cfg *Config) *Peer {
	return newPeerBase(cfg, true)
}

// NewOutboundPeer returns a new outbound wbcoin peer.
