...
/*
Package peer provides a common base for creating and managing WBC network
peers.

Overview

This package builds upon the wire package, which provides the fundamental
primitives necessary to speak the wbcoin wire protocol, in order to simplify
...
A quick overview of the major features peer provides are as follows:
 ...
 - Provides a basic concurrent safe wbcoin peer for handling wbcoin
   communications via the peer-to-peer protocol
 - Full duplex reading and writing of wbcoin protocol messages
 ...
 - Flexible peer configuration
   ...
   - Ability to register callbacks for handling wbcoin protocol messages
...
caller to specify things such as the user agent name and version, the wbcoin
network to use, which services it supports, and callbacks to invoke when wbcoin
...
In order to do anything useful with a peer, it is necessary to react to wbcoin
...
For convenience, a callback hook for all of the currently supported wbcoin
...
(https://godoc.org/bitbucket.org/siegfriedvmblockchain/siegfried/wbc/wire#hdr-Bitcoin_Improvement_Proposals)
*/
package peer
