...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/wbcoin/wbc/peer)
...
```bash
$ go get -u github.com/wbcoin/wbc/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/wbcoin/wbc/peer#example-package--NewOutboundPeer)
