...
/*
wbc is a full-node wbcoin implementation written in Go.

The default options are sane for most users.  This means wbc will work 'out of
...
parsed when wbc starts up.  By default, the configuration file is located at
~/.wbc/wbc.conf on POSIX-style operating systems and %LOCALAPPDATA%\wbc\wbc.conf
