...
// Harness fully encapsulates an active wbc process, along with an embedded
// dcrwallet to provide a unified platform for creating RPC-driven integration
// tests involving wbc. The active wbc node will typically be run in simnet
...
// spends. The active wbc process is fully managed by Harness, which handles
...
func (h *Harness) SetUp(createTestChain bool, numMatureOutputs uint32) error {
	...
	// Get a new address from the wallet to be set with wbc's --miningaddr
...
// wbc process belonging to this Harness instance. If the initial connection
