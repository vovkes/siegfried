...
func getInfo(icmd interface{}, w *wallet.Wallet, chainClient *dcrrpcclient.Client) (interface{}, error) {
	// Call down to wbc for all of the information in this command known
	// by them.
...
// appear in the blockchain, or any tx that has arrived in the wbc mempool).
...
func sendMany(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	...
	// Recreate address/amount pairs, using wbcutil.Amount.
...
func signRawTransaction(icmd interface{}, w *wallet.Wallet, chainClient *dcrrpcclient.Client) (interface{}, error) {
	...
	// TODO: really we probably should look these up with wbc anyway to
	...
	// querying wbc with getrawtransaction. We queue up a bunch of async
