...
// functional wbcoin wallet RPC server.  This can be called to enable RPC
...
// a chain server request that is handled by passing the request down to wbc.
//
...
func (s *Server) handlerClosure(ctx context.Context, request *dcrjson.Request) lazyHandler {
	...
	if chainClient != nil {
		// The "help" RPC must use an HTTP POST client when calling down to wbc
