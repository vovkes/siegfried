...
var helpDescsEnUS = map[string]string{
	...
	"getbalance--result0":    "The balance of 'account' valued in wbcoin",
	"getbalance--result1":    "The balance of all accounts valued in wbcoin",
	...
	"getreceivedbyaccount--result0":  "The total received amount valued in wbcoin",
	...
	"getreceivedbyaddress--result0":  "The total received amount valued in wbcoin",
	...
	"gettransactionresult-amount":          "The total amount this transaction credits to the wallet, valued in wbcoin",
	...
	"listaccounts--result0--desc":  "JSON object with account names as keys and wbcoin amounts as values",
	"listaccounts--result0--key":   "The account name",
	"listaccounts--result0--value": "The account balance valued in wbcoin",
	...
	"listreceivedbyaccountresult-amount":        "Total amount received by payment addresses of the account valued in wbcoin",
	...
	"listreceivedbyaddressresult-amount":            "Total amount received by the payment address valued in wbcoin",
	...
	"listtransactionsresult-amount":            "The value of the transaction output valued in wbcoin",
	...
	"listunspentresult-amount":        "The amount of the output valued in wbcoin",
	...
	"sendfrom-amount":      "Amount to send to the payment address valued in wbcoin",
	...
	"sendmany-amounts--desc":  "JSON object using payment addresses as keys and output amounts valued in wbcoin to send to each address",
	"sendmany-amounts--key":   "Address to pay",
	"sendmany-amounts--value": "Amount to send to the payment address valued in wbcoin",
	...
	"sendtoaddress-amount":    "Amount to send to the payment address valued in wbcoin",
	...
	"sendtomultisig-amount":      "Amount to send to the payment address valued in wbcoin",
	...
	"settxfee-amount":    "The new fee per kB of the serialized tx size valued in wbcoin",
	...
	"getunconfirmedbalance--result0":  "Total amount of all unmined unspent outputs of the account valued in wbcoin.",
	...
	"setticketfee-fee":       "The new fee per kB of the serialized tx size valued in wbcoin",
