...
// Flags.
var opts = struct {
	TestNet               bool                `long:"testnet" description:"Use the test wbcoin network"`
	SimNet                bool                `long:"simnet" description:"Use the simulation wbcoin network"`
...
func init() {
	...
	if opts.TestNet && opts.SimNet {
		fatalf("Multiple wbcoin networks may not be used simultaneously")
	}
