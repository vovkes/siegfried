...
// spending to it in the blockchain or wbc mempool), the next chained address
// is returned.
...
func (w *Wallet) SignMessage(msg string, addr dcrutil.Address) (sig []byte, err error) {
	...
	wire.WriteVarString(&buf, 0, "WBC Signed Message:\n")
...
// returning the total amount of wbcoin received for all accounts.
...
// returning the total amount of wbcoin received for a single wallet
// address.
